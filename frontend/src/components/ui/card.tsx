...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      "rounded-2xl border border-white/10 bg-black/60 text-white shadow-xl backdrop-blur-sm transition-all duration-300 hover:shadow-2xl hover:border-white/20",
      className
    )}
    {...props}
  />
