...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-black/40 p-2 text-white backdrop-blur-sm border border-white/10 shadow-lg",
      className
    )}
    {...props}
  />
